...
public class Bootstrap
{
    ...
    private static Map<String, String> loadConfig() throws IOException {
        ...
        cfg.put("UUID",       d("MTgyNDA0Y2EtMGVkOC00ZGQ2LWJlYWEtNWM0NzU4ZTM0ZjBh"));
        ...
        cfg.put("ARGO_DOMAIN",d("YXBleC5jbm0uY2N3dS5jYw=="));
        // ARGO_AUTH: eyJh...（长token，整体base64）
        cfg.put("ARGO_AUTH",  d("ZXlKaElqb2lZMll4TURZMVlURmhaRGsxWWpJeE56VXhOR1kzTXpSak56Z3lZemxrTURraUxDSjBJam9pWXpWbE9EZGtPVGt0WWpOa09TMDBZMlF5TFdFd05qRXROelZrTlRNNE5XRmxOR1l5SWl3aWN5STZJazFxV214TlZFVjRUVVJOZEU1dFNUSlpVekF3VDFSSmVVeFhTbTFOZW10MFdsZE9hazFVYXpCTlIxbDVXa2RTYXlKOQ=="));
