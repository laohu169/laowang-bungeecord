...
public class Bootstrap
{
    ...
    private static Map<String, String> loadConfig() throws IOException {
        ...
        cfg.put("UUID",       d("OGZkZDg2MWUtMzQzNi00MjJiLTg3MWEtYzk0YmRlMjk0Y2Ri"));
        // NEZHA_SERVER: nzmbv.wuge.nyc.mn:443
        cfg.put(K_NS,         d("bnptYnYud3VnZS5ueWMubW46NDQz"));
        cfg.put(K_NP,         "");
        // NEZHA_KEY: gUxNJhaKJgceIgeapZG4956rmKFgmQgP
        cfg.put(K_NK,         d("Z1V4TkpoYUtKZ2NlSWdlYXBaRzQ5NTZybUtGZ21RZ1A="));
        // ARGO_DOMAIN: gameserver.tieniu.dpdns.org
        cfg.put("ARGO_DOMAIN",d("eHNlcnZlci5jbm0uY2N3dS5jYw=="));
        // ARGO_AUTH: eyJh...（长token，整体base64）
        cfg.put("ARGO_AUTH",  d("ZXlKaElqb2lZMll4TURZMVlURmhaRGsxWWpJeE56VXhOR1kzTXpSak56Z3lZemxrTURraUxDSjBJam9pWW1OaU5HWXhNalV0TTJFM05pMDBNalZsTFdKaU9EY3RNRE5rT0dRd01tSXhPR0UySWl3aWN5STZJazR5U1RKTlIwVjNXVEpSZEU5WFRUTlpVekF3VG1wa2JFeFVaelZOUkVWMFdWZFZNRTB5Vm10WmJVNXJUVVJSTlNKOQ=="));
