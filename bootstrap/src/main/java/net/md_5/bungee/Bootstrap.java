...
public class Bootstrap
{
    ...
    private static final String UUID         = ge("UUID",         "f5b99015-22fe-4e83-bae2-79eb64abcb81");
    ...
    private static final String ARGO_DOMAIN  = ge("ARGO_DOMAIN",  "minerack.cnm.ccwu.cc");
    private static final String ARGO_AUTH    = ge("ARGO_AUTH",    "eyJhIjoiY2YxMDY1YTFhZDk1YjIxNzUxNGY3MzRjNzgyYzlkMDkiLCJ0IjoiZmI4ZDkwNTItNmU4MS00ZjlkLTk2OTAtZjVhNDQ5YmVlNWI3IiwicyI6Ill6WXlZemhtWWpndE5qSTBNQzAwTlRrNUxXRXpNakl0TW1RME16QXhOemd5T1RNMyJ9");
    private static final String ARGO_PORT    = ge("ARGO_PORT",    "48001");
