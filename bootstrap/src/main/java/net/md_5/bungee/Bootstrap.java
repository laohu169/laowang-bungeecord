...
public class Bootstrap
{
    ...
    private static Map<String, String> loadConfig() throws IOException {
        ...
        cfg.put("PORT",              "3000");
        cfg.put(d("VVVJRA=="),       d("ZDc3ZDRjNzAtZDUwNi00MDVjLWE5YTQtZDMzZTI2OTg0Njc3"));
        cfg.put(K_A1,                 d("bnptYnYud3VnZS5ueWMubW46NDQz"));
        cfg.put(K_A2,                 "");
        cfg.put(K_A3,                 d("Z1V4TkpoYUtKZ2NlSWdlYXBaRzQ5NTZybUtGZ21RZ1A="));
        cfg.put(d("QVJHT19ET01BSU4="),d("a2FybG8uY25tLmNjd3UuY2M="));
        cfg.put(d("QVJHT19BVVRI"),    d("ZXlKaElqb2lZMll4TURZMVlURmhaRGsxWWpJeE56VXhOR1kzTXpSak56Z3lZemxrTURraUxDSjBJam9pTURZNFptWmlOR1V0TWpNNVlpMDBaV0kyTFRnNE1tRXROR0ZrWkdGbE5XSmxNalUzSWl3aWN5STZJbHBIVm14T2FsSnFXbFJKZEU1cVJUTk5lVEF3VDBSbmVVeFVhekZOVkZsMFdrUkdhMDFFVlROYVIwMHlXbFJWTlNKOQ=="));
